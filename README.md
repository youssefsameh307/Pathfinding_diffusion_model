...
1. plot allpahts from region a to b and then plot the diffusions 
2. show diversity plots 
3. how much it understands the world
4. comparison between vae and basis 
5. show how good the paths are on a new world
6. only show the old ones if u have a place
